...
vim.api.nvim_create_autocmd("LspAttach", {
  ...
  callback = function(event)
    ...
    map("gH", vim.lsp.buf.type_definition, "Goto Type Definition")
    map("gS", vim.lsp.buf.document_symbol, "Goto Document Symbol")
    map("gW", vim.lsp.buf.workspace_symbol, "Goto Workspace Symbol")
